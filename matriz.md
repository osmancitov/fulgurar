...
**El conteo de talleres se declara en `parametros-globales.md`:**
Ningún otro archivo declara cuántos talleres hay — los demás describen el suyo sin enumerar el sistema completo.
...
*Para valores actuales — corpus procesados, talleres activos, lucidez — ver `parametros-globales.md`.*

**Fulgurar** es un sistema de lectura profunda con un protocolo de entrada, seis talleres activos y el Oráculo acumulando lucidez.
